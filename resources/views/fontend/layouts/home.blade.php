          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              <li class="nav-item active">
                <a class="nav-link" href="{{route('fontend.home')}}">Home <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
      ...
      <div class="container ">
        <div class="row">
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="{{asset('ui/fontend')}}/images/o1.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Tasty Thursdays
          ...
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="{{asset('ui/fontend')}}/images/o2.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Pizza Days
